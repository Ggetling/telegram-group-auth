...
class AuthStore(Protocol):
    ...
    #: Delete every trace of one person, returning whether a row existed. The
    #: roster holds a username and a name, so a bot asked to erase somebody's
    #: data needs this; see :meth:`MembershipChecker.erase_user`, which drops
    #: the cached verdict as well. It is the one method the gate never calls.
